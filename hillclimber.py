...
def random_hillclimber(schedule, courses, desired_score, maximum_duration=None):
    ...
    plt.title("random_hillclimber; desired_score: " + str(desired_score) + ", elapsed_time: " + str(
        int(elapsed_time)) + "sec")
    plt.savefig("random_hillclimber; desired_score: ")
    plt.show()
    print "\trandom_hillclimber; score: ", score_schedule, "elapsed time: ", int(elapsed_time / 60), "Min", int(
        elapsed_time % 60), "sec"
...
"""
    ...
    Hillclimber algorithm based on guided mutations.

"""


def guided_hillclimber(schedule, courses, desired_score, maximum_duration = None):
    ...
    while score_schedule < desired_score:
        ...
        # For multiple_activities: check_multiple_activities.
            ...
            swap_index_2 = random.randrange(len(schedule))
            while (new_schedule[swap_index_1].day == new_schedule[swap_index_2].day) and (
                new_schedule[swap_index_1].time == new_schedule[swap_index_2].time):
                swap_index_2 = random.randrange(len(schedule))
    ...
    elapsed_time = time.time() - start_time
    print "\tguided_hillclimber; score: ", score_schedule, "elapsed time: ", int(elapsed_time / 60), "Min", int(
        elapsed_time % 60), "sec"
    ...
    plt.title("guided_hillclimber; final_score: " + str(score_schedule) + ", elapsed_time: " + str(
        int(elapsed_time)) + " sec" + "desired_score: " + str(desired_score))
